          ...
          <div class="col-sm-6 col-sm-offset-3">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="form">
              <form action="Clientes?operacion=alta" method="post" role="form"accept-charset="UTF-8" role="form">
                  <fieldset>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control" placeholder="Username" name="nombre" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="fa fa-fw fa-user-secret"></i></span>
                        <input type="text" class="form-control" placeholder="Subname" name="apellidos" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="input-group input-group-lg">
