          ...
          <div class="col-sm-6 col-sm-offset-3">
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <form action="clientes?operacion=baja" method="POST" accept-charset="UTF-8" role="form">
                  <fieldset>
                    ...
                    <input class="btn btn-lg btn-primary btn-block" type="submit" value="Dar de baja">
                  </fieldset>
                </form>
              </div>
            </div>
